...
clone_handler = CommandHandler(BotCommands.CloneCommand, cloneNode, filters=filters=CustomFilters.authorized_chat | CustomFilters.authorized_user, run_async=True), run_async=True)
